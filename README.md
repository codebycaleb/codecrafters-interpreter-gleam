[![progress-banner](https://backend.codecrafters.io/progress/interpreter/946d6800-3593-4508-abe4-927505192c21)](https://app.codecrafters.io/users/codecrafters-bot?r=2qF)
...
The entry point for your program is in `src/lox.gleam`. Study and uncomment the
...
2. Run `./lox.sh` to run your program, which is implemented in
   `src/lox.gleam`.
